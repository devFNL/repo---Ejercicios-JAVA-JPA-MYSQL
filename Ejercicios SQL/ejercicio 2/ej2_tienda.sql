...
select f.codigo from fabricante f, producto p where f.codigo = p.codigo_fabricante group by p.codigo_fabricante;
...
-- esta es otra forma, no hacen falta los otros datos, pero me tira 2 valores, el 2ndo null no se porque
select *
from producto
where precio = (
    select MAX(precio)
