...
-- 19. Obtener los nombres de los departamentos que sean de “Ventas”, “Investigación” o ‘Mantenimiento.
...
select d.nombre_depto, AVG(e.sal_emp) as promedio_por_departamento
from empleados e
...
select d.nombre_depto, count(e.id_emp)
