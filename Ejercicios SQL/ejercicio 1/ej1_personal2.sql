...
-- 7. Obtener los datos de los empleados vendedor, ordenados por nombre alfabéticamente.
...
select nombre as Nombre_Completo, cargo_emp as Cargo from empleados;
...
select e.nombre, e.id_depto, d.nombre_depto, d.nombre_jefe_depto
from empleados e
