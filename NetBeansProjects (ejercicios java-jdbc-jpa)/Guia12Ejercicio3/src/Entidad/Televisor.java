...
public final class Televisor extends Electrodomestico {
    ...
    public String toString() {
        return super.toString() + "Televisor. Resolucion: " + resolucion + " Sintonizador TDT: " + sintonizadorTDT; // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
}
